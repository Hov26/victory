(function($, window, document, undefined) {
    ...
    Owl.prototype.isVisible = function() { return this.settings.checkVisibility ? this.$element.is(':visible') : !0 };
    ...
    Owl.prototype.onResize = function() {
        ...
        this.enter('resizing');
        if (this.trigger('resize').isDefaultPrevented()) { this.leave('resizing'); return !1 }
    ...
    Owl.prototype.onDragEnd = function(event) {
        ...
        if (delta.x !== 0 && this.is('dragging') || !this.is('valid')) {
            ...
            if (Math.abs(delta.x) > 3 || new Date().getTime() - this._drag.time > 300) { this._drag.target.one('click.owl.core', function() { return !1 }) }
        }
        if (!this.is('dragging')) { return }
        this.leave('dragging');
    ...
    Owl.prototype.relative = function(position) { position -= this._clones.length / 2; return this.normalize(position, !0) };
...
(function($, window, document, undefined) {
    ...
    function test(property, prefixed) {
        ...
        $.each((property + ' ' + prefixes.join(upper + ' ') + upper).split(' '), function(i, property) { if (style[property] !== undefined) { result = prefixed ? property : !0; return !1 } });
        return result
    }
