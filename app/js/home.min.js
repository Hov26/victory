...
$(document).ready(function() {
    ...
    $(window).scroll(function() {
        if (($(this).scrollTop()) > ($('.license').position().top - 500)) {
            line.addClass("animate");
            typeTextOnce()
        }
        if ($(this).scrollTop() > 300) {
            $('.hero-slider-wrapper-wave').fadeIn(1000)
        }
        if (($(this).scrollTop()) > ($('.row-1').position().top - 300)) {
            $('.home-potfolio-wave').fadeIn(1000)
        }
        if (($(this).scrollTop()) > ($('.homepage .founder').position().top - 400)) {
            $('.founder-wave').fadeIn(1000)
        }
        if (($(this).scrollTop()) > ($('.homepage .contact').position().top - 400)) {
            $('.contact-wave').fadeIn(1000)
        }
        // Show service slider black content
        if (($(this).scrollTop()) > ($('.homepage .section-service-slider ').position().top - 200)) {
            $('.homepage .title-slider-item').attr('style', 'opacity: 1;')
        }
    });
